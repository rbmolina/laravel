...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
                ...
                <section id="action-bar">
                    ...
                    <div id="user-menu">
                        ...
                        <nav class="dropdown">
                            <ul>
                                <li>
                                    <a href="#">{{ HTML::image('img/user-icon.gif','Bobby Molina') }} Bobby Molina
                                        {{ HTML::image('img/down-arrow.gif','Bobby Molina') }} </a>
                                    <ul>
        ...
        <script>window.jQuery || document.write("{{ HTML::script('js/jquery-1.9.1.min.js') }}")</script>
